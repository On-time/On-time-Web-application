...
namespace OnTimeWebApplication.Data.Migrations
{
    ...
    [Migration("25591228065111_Add initial business models to database")]
    partial class Addinitialbusinessmodelstodatabase
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OnTimeWebApplication.Models.Teacher", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OnTimeWebApplication.Models.Subject", b =>
                {
                    b.HasOne("OnTimeWebApplication.Models.Teacher", "Teacher")
                        .WithMany("Subjects")
